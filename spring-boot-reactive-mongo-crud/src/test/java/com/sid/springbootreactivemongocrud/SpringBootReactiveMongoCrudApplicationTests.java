package com.sid.springbootreactivemongocrud;

import com.sid.springbootreactivemongocrud.controller.ProductController;
import com.sid.springbootreactivemongocrud.dto.ProductDto;
import com.sid.springbootreactivemongocrud.service.ProductService;
...
class SpringBootReactiveMongoCrudApplicationTests {
    ...
    public void getProductsTest() {
        ...
        StepVerifier.create(responseBody)
                ...
                .expectNext(new ProductDto("103", "TV", 1, 55000))
                .verifyComplete();
    }
